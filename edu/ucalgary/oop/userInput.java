...
public class UserInput {
    ...
    input.ItemNumber=scanner.nextLine();
...
*/
    if(input.validateCategory(input)) {
    	if(input.validateType(input)) {
	...
	finalList=myJDBC.selectFurnitureToOrder(input.category, input.type, input.ItemNumber);
    	}
    	}else {
	...
	*/
	boolean isOrderedItemsID= UserInput.validateInput(finalList[0]);
	if(isOrderedItemsID) {
	...
	/**
	    ...
	    *    
	    */
	public boolean validateCategory(UserInput input) {
	...
	/**
	    ...
	    */
	public boolean validateType(UserInput input) {
	  ...
	  /**
	    ...
	    * else true
	    */
	public boolean validateNumber(UserInput input) {
		 if(Integer.parseInt(input.ItemNumber)<1) {
			 return true;
		 }
		 return false;
	}
